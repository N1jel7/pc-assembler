...
(
    component_parent_type_id bigint unique,
    id                       bigint       not null,
...
(
    ...
    id           bigint       not null,
    primary key (id),
    constraint uk_specification_component_name unique (component_id, name)
);
...
(
    ...
    value varchar(50),
    primary key (component_id, specification_id)
);
...
alter table if exists specification
    add constraint FKo7emww7ubnkblw7i5kmlgdkgc foreign key (component_id) references components;*/
